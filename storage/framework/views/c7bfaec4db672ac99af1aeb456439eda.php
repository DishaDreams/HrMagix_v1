...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-lg-6 col-md-6">
            ...
            <?php echo e(Form::select('employee_id', $employees, null, ['class' => 'form-control select2', 'required' => 'required', 'id' => 'employee_id'])); ?>

        </div>
        <div class="form-group col-lg-6 col-md-6">
            <?php echo e(Form::label('designation_id', __('Designation'), ['class' => 'col-form-label'])); ?>

            <?php echo e(Form::select('designation_id', $designations, null, ['class' => 'form-control select2 designation_id' , 'required' => 'required'])); ?>
...
</script><?php /**PATH /var/www/vhosts/hrmagix.com/httpdocs/in/app/resources/views/promotion/create.blade.php ENDPATH**/ ?>